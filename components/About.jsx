            ...
            <div class="relative flex justify-end">
                <div class="bg-gradient-to-r from-[#090914]/70 to-[#0C0C12] overflow-hidden lg:w-7/12 bg-opacity-90 backdrop-blur-lg">
                    <div class="p-6 md:py-10 sm:p-8 md:px-16">
                        ...
                        <blockquote>
                            <p class="text-3xl font-normal text-white xl:text-4xl">Meer over mij</p>
                        </blockquote>
                        <p class="mt-12 text-xl font-normal text-gray-400 sm:mt-16">Hi, mijn naam is Regilio Spee en ik woon in Amsterdam. Juli 2021 heb ik mijn opleiding software development aan het Mediacollege Amsterdam succesvol afgerond en studeer ik sinds september 2022 HBO-ICT Business & IT management aan de Hogeschool van Amsterdam. Buiten mijn studie werk ik als Medior-klantadviseur bij Budget Alles-in-1 en ben ik bezig met werkzaamheden voor mijn eigen bedrijf Pandu.</p>
