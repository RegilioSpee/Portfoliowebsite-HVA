        ...
        <div class="">
            <section class="py-12 bg-black sm:pb-16 lg:pb-20 xl:pb-24">
                <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div class="relative">
                        <div class="lg:w-2/3">
                            <p class="text-sm font-normal tracking-widest text-gray-300 uppercase">Business & IT student</p>
                            ...
                            <p class="max-w-lg mt-4 text-xl font-normal text-gray-400 sm:mt-8">Dit is mijn portfoliowebsite.</p>
