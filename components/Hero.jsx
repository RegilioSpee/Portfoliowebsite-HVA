                    ...
                    <div class="relative">
                        <div class="lg:w-2/3">
                            ...
                            <div class="relative inline-flex items-center justify-center mt-8 sm:mt-12 group">
                                ...
                                <a href="/#about" title="" class="relative inline-flex items-center justify-center px-8 py-3 text-base font-normal text-white bg-black border border-transparent rounded-full" role="button"> Meer over mij weten </a>
                            </div>
                        </div>
