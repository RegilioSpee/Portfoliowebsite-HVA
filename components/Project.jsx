    ...
    return (
        <div {...storyblokEditable(blok)} >
            <div className="relative group">
                ...
                <div className="mt-6">
                    <a href={blok.description} target="_blank" title="" className="flex items-center text-gray-400" role="button">
                        {/* <span className="w-32 transition-all duration-300 lg:opacity-0 lg:group-hover:opacity-100">Website</span> */}
